  ...
  <body>
    ...
    <section>
        <div class="header-name">
            <h1>You've been added to a new organization.</h1>
        </div>
        <div class="main-b main-b-ng">
            <div class="name-e">
                <p>Hi, {{ $email }},</p>
            </div>
            <div class="main-i">
                <img src="{{ asset('storage/emails/img/randomrtuff.png') }}" alt="">
            </div>

            <a href="{{ URL('organization/' . $slug . '/receivers/invite/' . $code) }}">
                <button class="button-m-a">Activate account</button>
            </a>
        </div>
    </section>
