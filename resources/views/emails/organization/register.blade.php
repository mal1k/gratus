...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ asset('storage/emails/img/fav.png') }}" type="png">
  ...
  <body>
    ...
    <section>
        ...
        <div class="main-b-r">
            ...
            <div class="main-i">
                <img src="{{ asset('storage/emails/img/powermovescalendar.png') }}" alt="">
            </div>
            <div class="main-pp">
                <p>Welcome to Gratus!</p>
                <p>You’ve been granted by Gratus to have an organization.</p>
                <p> Now you can track gratuities of your employees, create groups, and invite new people to the application.</p>
                <br>
                <p>Email: {{ $email }}</p>
            ...
            <a href="{{ URL('organization/' . $slug . '/login') }}">
                <button class="button-m-a">Organization page</button>
            </a>
        </div>
    </section>
