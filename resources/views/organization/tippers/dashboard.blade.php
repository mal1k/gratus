...
<div class="card mb-5 mb-xl-8">
    ...
    <!-- <div class="card-header border-0">
        <div class="card-toolbar">
            <a href="{{ route('organizationtippers.create', $org->slug) }}" class="btn btn-sm btn-primary">
            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-225px">Payment</th>
                ...
                @foreach ( $tippers as $tipper )
                    <tr>
                        ...
                        <td class="text-end">
                            <form method="POST" action="{{ route('organizationtippers.remove', [$org->slug, $tipper]) }}">
                                @if ( $tipper->status == 'Active' )
                                <a href="{{ route('organizationtippers.show', [$org->slug, $tipper]) }}" class="btn btn-icon btn-bg-light btn-active-color-primary bg-warning btn-sm me-1">
                                ...
                                @endif
                                <!-- <a href="{{ route('organizationtippers.edit', [$org->slug, $tipper]) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
