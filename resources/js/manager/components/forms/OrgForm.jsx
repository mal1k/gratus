...
class Form extends React.Component
{
    ...
    */
    render()
    {
        ...
        const groupLink = "/manager/organization/groups/" + this.state.item.id;
        ...
        <div>
            <form onSubmit={ this.handleSubmit }>
                    ...
                    <div className="card-header card-header-with-padding">
                        <div className="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                {/* <a href="/manager/organizations/providers" className="btn btn-warning m-1">Service providers</a> */}
                ...
                <div className="card">
                    ...
                    { isRendered ? this.getFormElements() : <Spinner /> }
            ...
            <div className="row text-center">
                <div className="col text-left">
                    <a href="/manager/receivers" className="btn btn-danger">Receivers</a>
                </div>

                <div className="col">
                    <a href="/manager/tippers" className="btn btn-danger">Tippers</a>
                </div>
                ...
                <div className="col">
                    <a href="#" className="btn btn-danger">Shifts</a>
                </div>
            </div>
        </div>
        );
